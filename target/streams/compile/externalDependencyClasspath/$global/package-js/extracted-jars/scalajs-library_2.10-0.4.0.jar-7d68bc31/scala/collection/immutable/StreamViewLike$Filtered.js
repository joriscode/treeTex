ScalaJS.is.scala_collection_immutable_StreamViewLike$Filtered = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_immutable_StreamViewLike$Filtered)))
});
ScalaJS.as.scala_collection_immutable_StreamViewLike$Filtered = (function(obj) {
  if ((ScalaJS.is.scala_collection_immutable_StreamViewLike$Filtered(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.immutable.StreamViewLike$Filtered")
  }
});
ScalaJS.isArrayOf.scala_collection_immutable_StreamViewLike$Filtered = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_immutable_StreamViewLike$Filtered)))
});
ScalaJS.asArrayOf.scala_collection_immutable_StreamViewLike$Filtered = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_immutable_StreamViewLike$Filtered(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.immutable.StreamViewLike$Filtered;", depth)
  }
});
ScalaJS.data.scala_collection_immutable_StreamViewLike$Filtered = new ScalaJS.ClassTypeData({
  scala_collection_immutable_StreamViewLike$Filtered: 0
}, true, "scala.collection.immutable.StreamViewLike$Filtered", undefined, {
...
//@ sourceMappingURL=StreamViewLike$Filtered.js.map
