ScalaJS.is.scala_collection_mutable_IndexedSeqView$TakenWhile = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_mutable_IndexedSeqView$TakenWhile)))
});
ScalaJS.as.scala_collection_mutable_IndexedSeqView$TakenWhile = (function(obj) {
  if ((ScalaJS.is.scala_collection_mutable_IndexedSeqView$TakenWhile(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.mutable.IndexedSeqView$TakenWhile")
  }
});
ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$TakenWhile = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_mutable_IndexedSeqView$TakenWhile)))
});
ScalaJS.asArrayOf.scala_collection_mutable_IndexedSeqView$TakenWhile = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$TakenWhile(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.mutable.IndexedSeqView$TakenWhile;", depth)
  }
});
ScalaJS.data.scala_collection_mutable_IndexedSeqView$TakenWhile = new ScalaJS.ClassTypeData({
  scala_collection_mutable_IndexedSeqView$TakenWhile: 0
}, true, "scala.collection.mutable.IndexedSeqView$TakenWhile", undefined, {
...
//@ sourceMappingURL=IndexedSeqView$TakenWhile.js.map
