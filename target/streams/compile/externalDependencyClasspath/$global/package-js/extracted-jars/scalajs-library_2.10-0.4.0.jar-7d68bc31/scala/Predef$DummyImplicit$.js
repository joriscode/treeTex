...
ScalaJS.c.scala_Predef$DummyImplicit$.prototype.dummyImplicit__Lscala_Predef$DummyImplicit = (function() {
  return new ScalaJS.c.scala_Predef$DummyImplicit().init___()
});
ScalaJS.c.scala_Predef$DummyImplicit$.prototype.dummyImplicit__ = (function() {
  return this.dummyImplicit__Lscala_Predef$DummyImplicit()
});
/** @constructor */
...
ScalaJS.moduleInstances.scala_Predef$DummyImplicit = undefined;
ScalaJS.modules.scala_Predef$DummyImplicit = (function() {
  if ((!ScalaJS.moduleInstances.scala_Predef$DummyImplicit)) {
    ScalaJS.moduleInstances.scala_Predef$DummyImplicit = new ScalaJS.c.scala_Predef$DummyImplicit$().init___()
  };
  return ScalaJS.moduleInstances.scala_Predef$DummyImplicit
});
