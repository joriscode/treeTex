ScalaJS.is.scala_collection_mutable_IndexedSeqView$Filtered = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_mutable_IndexedSeqView$Filtered)))
});
ScalaJS.as.scala_collection_mutable_IndexedSeqView$Filtered = (function(obj) {
  if ((ScalaJS.is.scala_collection_mutable_IndexedSeqView$Filtered(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.mutable.IndexedSeqView$Filtered")
  }
});
ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$Filtered = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_mutable_IndexedSeqView$Filtered)))
});
ScalaJS.asArrayOf.scala_collection_mutable_IndexedSeqView$Filtered = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$Filtered(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.mutable.IndexedSeqView$Filtered;", depth)
  }
});
ScalaJS.data.scala_collection_mutable_IndexedSeqView$Filtered = new ScalaJS.ClassTypeData({
  scala_collection_mutable_IndexedSeqView$Filtered: 0
}, true, "scala.collection.mutable.IndexedSeqView$Filtered", undefined, {
...
//@ sourceMappingURL=IndexedSeqView$Filtered.js.map
