...
// my modification
  ...
  this.enableRaiser = new jsgl.util.EventRaiser();


  jsgl.elements.AbstractElement.prototype.disable = function() {

  this.enabled = false;
  this.enableRaiser.raiseEvent();
  this.onChangeRaiser.raiseEvent();
}


jsgl.elements.AbstractElement.prototype.enable = function() {
  ...
  jsgl.elements.AbstractElement.prototype.isEnable = function() {
