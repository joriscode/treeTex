ScalaJS.is.scala_collection_mutable_IndexedSeqView$DroppedWhile = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_mutable_IndexedSeqView$DroppedWhile)))
});
ScalaJS.as.scala_collection_mutable_IndexedSeqView$DroppedWhile = (function(obj) {
  if ((ScalaJS.is.scala_collection_mutable_IndexedSeqView$DroppedWhile(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.mutable.IndexedSeqView$DroppedWhile")
  }
});
ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$DroppedWhile = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_mutable_IndexedSeqView$DroppedWhile)))
});
ScalaJS.asArrayOf.scala_collection_mutable_IndexedSeqView$DroppedWhile = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$DroppedWhile(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.mutable.IndexedSeqView$DroppedWhile;", depth)
  }
});
ScalaJS.data.scala_collection_mutable_IndexedSeqView$DroppedWhile = new ScalaJS.ClassTypeData({
  scala_collection_mutable_IndexedSeqView$DroppedWhile: 0
}, true, "scala.collection.mutable.IndexedSeqView$DroppedWhile", undefined, {
...
//@ sourceMappingURL=IndexedSeqView$DroppedWhile.js.map
