ScalaJS.is.scala_collection_SeqViewLike$Appended = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_SeqViewLike$Appended)))
});
ScalaJS.as.scala_collection_SeqViewLike$Appended = (function(obj) {
  if ((ScalaJS.is.scala_collection_SeqViewLike$Appended(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.SeqViewLike$Appended")
  }
});
ScalaJS.isArrayOf.scala_collection_SeqViewLike$Appended = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_SeqViewLike$Appended)))
});
ScalaJS.asArrayOf.scala_collection_SeqViewLike$Appended = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_SeqViewLike$Appended(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.SeqViewLike$Appended;", depth)
  }
});
ScalaJS.data.scala_collection_SeqViewLike$Appended = new ScalaJS.ClassTypeData({
  scala_collection_SeqViewLike$Appended: 0
}, true, "scala.collection.SeqViewLike$Appended", undefined, {
...
//@ sourceMappingURL=SeqViewLike$Appended.js.map
