ScalaJS.is.scala_collection_mutable_IndexedSeqView$Reversed = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_mutable_IndexedSeqView$Reversed)))
});
ScalaJS.as.scala_collection_mutable_IndexedSeqView$Reversed = (function(obj) {
  if ((ScalaJS.is.scala_collection_mutable_IndexedSeqView$Reversed(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.mutable.IndexedSeqView$Reversed")
  }
});
ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$Reversed = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_mutable_IndexedSeqView$Reversed)))
});
ScalaJS.asArrayOf.scala_collection_mutable_IndexedSeqView$Reversed = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_mutable_IndexedSeqView$Reversed(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.mutable.IndexedSeqView$Reversed;", depth)
  }
});
ScalaJS.data.scala_collection_mutable_IndexedSeqView$Reversed = new ScalaJS.ClassTypeData({
  scala_collection_mutable_IndexedSeqView$Reversed: 0
}, true, "scala.collection.mutable.IndexedSeqView$Reversed", undefined, {
...
//@ sourceMappingURL=IndexedSeqView$Reversed.js.map
