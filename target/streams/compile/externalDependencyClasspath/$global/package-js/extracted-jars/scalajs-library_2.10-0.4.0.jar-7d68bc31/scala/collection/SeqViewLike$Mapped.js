ScalaJS.is.scala_collection_SeqViewLike$Mapped = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_SeqViewLike$Mapped)))
});
ScalaJS.as.scala_collection_SeqViewLike$Mapped = (function(obj) {
  if ((ScalaJS.is.scala_collection_SeqViewLike$Mapped(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.SeqViewLike$Mapped")
  }
});
ScalaJS.isArrayOf.scala_collection_SeqViewLike$Mapped = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_SeqViewLike$Mapped)))
});
ScalaJS.asArrayOf.scala_collection_SeqViewLike$Mapped = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_SeqViewLike$Mapped(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.SeqViewLike$Mapped;", depth)
  }
});
ScalaJS.data.scala_collection_SeqViewLike$Mapped = new ScalaJS.ClassTypeData({
  scala_collection_SeqViewLike$Mapped: 0
}, true, "scala.collection.SeqViewLike$Mapped", undefined, {
...
//@ sourceMappingURL=SeqViewLike$Mapped.js.map
