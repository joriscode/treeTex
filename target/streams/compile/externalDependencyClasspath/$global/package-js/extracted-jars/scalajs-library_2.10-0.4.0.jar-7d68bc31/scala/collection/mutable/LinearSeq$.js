/** @constructor */
ScalaJS.c.scala_collection_mutable_LinearSeq$ = (function() {
  ScalaJS.c.scala_collection_generic_SeqFactory.call(this)
});
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype = new ScalaJS.inheritable.scala_collection_generic_SeqFactory();
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype.constructor = ScalaJS.c.scala_collection_mutable_LinearSeq$;
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype.canBuildFrom__Lscala_collection_generic_CanBuildFrom = (function() {
  return this.ReusableCBF__Lscala_collection_generic_GenTraversableFactory$GenericCanBuildFrom()
});
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype.newBuilder__Lscala_collection_mutable_Builder = (function() {
  return new ScalaJS.c.scala_collection_mutable_MutableList().init___()
});
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype.canBuildFrom__ = (function() {
  return this.canBuildFrom__Lscala_collection_generic_CanBuildFrom()
});
/** @constructor */
ScalaJS.inheritable.scala_collection_mutable_LinearSeq$ = (function() {
  /*<skip>*/
});
ScalaJS.inheritable.scala_collection_mutable_LinearSeq$.prototype = ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype;
...
}, false, "scala.collection.mutable.LinearSeq$", ScalaJS.data.scala_collection_generic_SeqFactory, {
...
ScalaJS.c.scala_collection_mutable_LinearSeq$.prototype.$classData = ScalaJS.data.scala_collection_mutable_LinearSeq$;
ScalaJS.moduleInstances.scala_collection_mutable_LinearSeq = undefined;
ScalaJS.modules.scala_collection_mutable_LinearSeq = (function() {
  if ((!ScalaJS.moduleInstances.scala_collection_mutable_LinearSeq)) {
    ScalaJS.moduleInstances.scala_collection_mutable_LinearSeq = new ScalaJS.c.scala_collection_mutable_LinearSeq$().init___()
  };
  return ScalaJS.moduleInstances.scala_collection_mutable_LinearSeq
});
