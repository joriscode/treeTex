ScalaJS.is.scala_collection_SeqViewLike$Filtered = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scala_collection_SeqViewLike$Filtered)))
});
ScalaJS.as.scala_collection_SeqViewLike$Filtered = (function(obj) {
  if ((ScalaJS.is.scala_collection_SeqViewLike$Filtered(obj) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwClassCastException(obj, "scala.collection.SeqViewLike$Filtered")
  }
});
ScalaJS.isArrayOf.scala_collection_SeqViewLike$Filtered = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scala_collection_SeqViewLike$Filtered)))
});
ScalaJS.asArrayOf.scala_collection_SeqViewLike$Filtered = (function(obj, depth) {
  if ((ScalaJS.isArrayOf.scala_collection_SeqViewLike$Filtered(obj, depth) || (obj === null))) {
    return obj
  } else {
    ScalaJS.throwArrayCastException(obj, "Lscala.collection.SeqViewLike$Filtered;", depth)
  }
});
ScalaJS.data.scala_collection_SeqViewLike$Filtered = new ScalaJS.ClassTypeData({
  scala_collection_SeqViewLike$Filtered: 0
}, true, "scala.collection.SeqViewLike$Filtered", undefined, {
...
//@ sourceMappingURL=SeqViewLike$Filtered.js.map
